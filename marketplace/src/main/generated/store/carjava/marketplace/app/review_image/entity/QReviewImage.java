...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = -1938787395L;
    ...
    public final store.carjava.marketplace.app.review.entity.QReview review;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new store.carjava.marketplace.app.review.entity.QReview(forProperty("review"), inits.get("review")) : null;
    }
